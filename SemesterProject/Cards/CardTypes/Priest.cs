...
namespace SemesterProject.Cards.CardTypes
{
    ...
    {
        public Priest(ECardType type, string name, string description, int damage, EDamageType elem) : base(type, name, description, damage, elem)
        {
        }
