...
{
    internal class DuplicateCard : Card
    {
        public DuplicateCard(ECardType type, string name, string description, int damage, EDamageType elem) : base(type, name, description, damage, elem)
        {
        }
