...
{
    internal class WaterSpell : Card
    {
        public WaterSpell(ECardType type, string name, string description, int damage, EDamageType elem) : base(type, name, description, damage, elem)
        {
        }
