...
namespace SemesterProject.Cards.CardTypes
{
    ...
    {
        public Wizard(ECardType type, string name, string description, int damage, EDamageType elem) : base(type, name, description, damage, elem)
        {
        }
